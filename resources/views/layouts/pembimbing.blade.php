      ...
      <div class="aside-loggedin">
        <div class="d-flex align-items-center justify-content-start">
          ...
          <div class="aside-alert-link">
            <a class="nav-link" data-toggle="tooltip" title="Sign out" href="{{ route('logout') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit();"><i data-feather="log-out"></i></a>
       ...
       <li class="nav-label mg-t-25">Akun</li>
        <li class="nav-item"><a href="{{Route('pembimbingProfil')}}" class="nav-link"><i data-feather="user"></i> <span>Profil</span></a></li>
          ...
          <li class="nav-item"><a href="{{Route('pembimbingLaporanPenelitian')}}" class="nav-link"><i data-feather="file"></i> <span>Laporan Akhir Penelitian</span></a></li>
        </ul>
      </div>
    </aside>
