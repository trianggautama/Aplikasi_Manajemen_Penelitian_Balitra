      ...
      <div>
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb breadcrumb-style1 mg-b-10">
            <li class="breadcrumb-item"><a href="#">Profil Pembimbing</a></li>
            <li class="breadcrumb-item active" aria-current="page">Profil User </li>
          </ol>
        </nav>
        <h4 class="mg-b-0 tx-spacing--1">Profil Pembimbing </h4>
      </div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    ...
                    <div class="form-group">
                      ...
                      <span class="tx-12 tx-color-03">{{$data->data_personal->NIP}}</span>
                    </div>
                    <div class="form-group">
                      <p class="tx-medium mg-b-2"><a href="" class="link-01">Jabatan</a></p>
                      <span class="tx-12 tx-color-03">{{$data->data_personal->jabatan}}</span>
                    </div>
                    <div class="form-group">
                      <p class="tx-medium mg-b-2"><a href="" class="link-01">No Hp</a></p>
                      <span class="tx-12 tx-color-03">{{$data->data_personal->no_hp}}</span>
                    </div>
                  </div>
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <span class="tx-12 tx-color-03">{{$data->data_personal->tempat_lahir}},
                        {{$data->data_personal->tanggal_lahir}}</span>
                    </div>
                    <div class="form-group">
                      <p class="tx-medium mg-b-2"><a href="" class="link-01">Alamat</a></p>
                      <span class="tx-12 tx-color-03">{{$data->data_personal->alamat}}</span>
                    </div>
                    <div class="form-group">
                      <p class="tx-medium mg-b-2"><a href="" class="link-01">username</a></p>
                      <span class="tx-12 tx-color-03">{{$data->username}}</span>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content tx-14">
          <div class="modal-header">
            <h6 class="modal-title" id="exampleModalLabel2">Edit Data</h6>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <div class="modal-body">
            <form action="{{Route('profilePembimbingUpdate')}}" method="POST">
              @csrf
              @method('PUT')
              <div class="form-group">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="date" name="no_hp" placeholder="no_hp" class="form-control"
              ...
              <div class="form-group">
                ...
                <textarea name="alamat" id="almaat" class="form-control">{{$data->data_personal->alamat}}</textarea>
              </div>
              <div class="form-group">
