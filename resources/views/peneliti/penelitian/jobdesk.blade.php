              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <p>Tanggal Upload:
                    ...
                    @if(carbon\carbon::parse($d->jobdesk_peneliti->created_at)->translatedFormat('dmY') <=
                      carbon\carbon::parse($d->batas_waktu)->translatedFormat('dmY')) <span class="text-primary">
